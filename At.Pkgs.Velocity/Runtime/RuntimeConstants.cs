...
namespace At.Pkgs.Velocity.Runtime
{
	using System;
	using Resource;
	...
	public struct RuntimeConstants
	{
		...
		public const String DEFAULT_RUNTIME_PROPERTIES = "At.Pkgs.Velocity.Runtime.Defaults.nvelocity.properties";
		public const String DEFAULT_RUNTIME_DIRECTIVES = "At.Pkgs.Velocity.Runtime.Defaults.directive.properties";
